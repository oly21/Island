...
public class PlantLeaves extends  Plant {
   public String typePicture  = BoxCharacteristicsObject.STRING_TYPE_PICTURE_LEAVES;
    public String typeString  =  BoxCharacteristicsObject.TYPE_STRING_PLANT_LEAVES;
